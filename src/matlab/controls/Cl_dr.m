%[Cl_dr]=Cl_dr(S_w,b_w,S_h,S_v,b_v,c_v,x_AC_vh,two_r_one,AR_v,l_v,Z_v, ...
%							eta_or,eta_ir,cr_cv,beta,kappa_v,Lambda_c2_v,lambda_v,delta_r,alpha)
%
%  Cl_dr - Variation of rolling moment coefficient  
...
function [Cl_dr]=Cl_dr(S_w,b_w,S_h,S_v,b_v,c_v,x_AC_vh,two_r_one,AR_v,l_v,Z_v, ...
							eta_or,eta_ir,cr_cv,beta,kappa_v,Lambda_c2_v,lambda_v,delta_r,alpha)
...
Cl_dr=-Cy_dr*(Z_v*cos(alpha)-l_v*sin(alpha))/b_w;
