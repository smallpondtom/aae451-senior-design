% [Cn_da]=Cn_da(S_w,AR_w,ca_cw,eta_ia,eta_oa,beta,kappa_w,....
%		Lambda_c4,lambda_w,tc_w,Cl_alpha_w,CL)
%
%  Cn_da - Variation of Yawing Moment Coefficient with  
%           Aileron Deflection 
%
%	[Ref.2]	Jan Roskam
...
%		kappa_w		- Ratio of wing 2D lift curve slope to 2pi
...
function [Cn_da]=Cn_da(S_w,AR_w,ca_cw,eta_ia,eta_oa,beta,kappa_w, ...
   Lambda_c4,lambda_w,tc_w,Cl_alpha_w,CL)


AR_cor=beta*AR_w/kappa_w;
...
Cl_d_prime=kappa_w/beta*Cl_delta_prime_cor;  % Eqn 11.2 [Ref 2]
...
Cn_da=K*CL*Cl_da;										% Eqn 11.9 [Ref 2]
