% [Cm_de]=Cm_de(S_w,S_h,AR_h,ce_ch,eta_oe,eta_ie,beta,kappa_h, ...
%                lambda_h,Lambda_c2_h,tc_h,delta_e,Cl_alpha_h,V_h)
%
%  Cm_de - Variation of airplane pitching moment coefficient with  
...
%		ce_ch			- Ratio of elevator flap chord to horizontal tail chord
...
%		Cl_alpha_h	- Horizontal tail 2D lift curve slope
%		V_h			- Horizontal tail volume coefficient


function [Cm_de]=Cm_de(S_w,S_h,AR_h,ce_ch,eta_oe,eta_ie,beta,kappa_h, ...
                lambda_h,Lambda_c2_h,tc_h,delta_e,Cl_alpha_h,V_h)
...
Cl_alpha_ratio=Cl_alpha_h/(2*pi);
Cl_delta_ratio=interlim2(cf_c_fig,Cl_alpha_ratio_fig,Cl_delta_ratio_fig,ce_ch,Cl_alpha_ratio);
