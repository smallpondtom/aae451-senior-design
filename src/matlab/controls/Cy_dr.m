%[Cy_dr]=Cy_dr(S_w,b_w,S_h,S_v,b_v,c_v,x_AC_vh,two_r_one,AR_v,l_v,Z_v, ...
%							eta_or,eta_ir,cr_cv,beta,kappa_v,Lambda_c2_v,lambda_v,delta_r,alpha)
%
%  Cy_dr - Variation of sideforce coefficient  
...
function [Cy_dr]=Cy_dr(S_w,b_w,S_h,S_v,b_v,c_v,x_AC_vh,two_r_one,AR_v,l_v,Z_v, ...
							eta_or,eta_ir,cr_cv,beta,kappa_v,Lambda_c2_v,lambda_v,delta_r,alpha)
...
Sh_Sv = S_h/S_v;
Sh_Sv_fig = ...
[0.00			0.059518	0.13083	0.19024	0.37989	0.51796	0.66361	0.85212	1.0836	1.3735	1.5652	1.7686	2.0000];
K_H_fig = ...
...
alpha_delta_cl=interlim1(cf_c_fig,alpha_delta_cl_fig,cr_cv);
AR_fig = [1 2 4 6 8 10];
